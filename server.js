...
app.post("/feedback", (req, res) => {
  try {
    ...
    console.log(userName,userFeedback,userRating);
...
const keywords = {
  Aboutus: ["company information", "our story","my page","about","ones self"],
  ...
  BlogPost: ["blog post", "article", "blog entry", "blog"],
  ...
  Default:["Default"],
  Ecommerce: ["ecommerce", "online store", "shopping platform","shopping"],
  ...
  VirtualArtGallery: ["virtual art gallery", "online art exhibition", "digital art showcase","art gallery"],
  Gallery: ["gallery", "image collection","album","photos"],
  ...
  JobPortal:["onboarding","job searching","companies"],
  Knowledge: ["knowledge", "learning resources","general"],
  ...
  Restaurent: ["restaurant", "dining", "food establishment","street food","food place","hotel"],
  ...
  SportsScoreUpdate:["sports","cricket","score card","cricbuzz","sports update"],
  Shopping:["Shopping","grocery"],
  Recipe:["recipe","cooking food","food instructions"],
  ArtCreation:["art creation","arts","drawing"],
  Voting:["ballet","votes","voting app","voting system","voting"]
};
